...
export interface AgriculturalMarket {
  slug: string;
  name: string;
  /** Customer-facing city or reference-area name, independent of the index product name. */
  locality: string;
...
export const agriculturalMarketLocation = (market: AgriculturalMarket) => `${market.locality}, ${market.administrativeArea}, ${market.country}`;
